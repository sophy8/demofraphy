...
@Component({
  ...
  templateUrl: './method-component-short.component.html',
  styleUrls: ['./method-component-short.component.scss']
})
export class MethodComponentShortComponent implements OnInit {
@Input() data;
public migration=[];
public people=[];
public death=[];
...
draw(data){
  ...
  let chart = am4core.create("components", am4charts.XYChart);
